/*
* **Include Guard**
* This  will make sure that we only include this header only once in reality 
*/

/*
* In the C and C++ programming languages, an #include guard, sometimes called a macro guard,
* header guard, or file guard, is a particular construct used to avoid the problem of double
* inclusion when dealing with the include directive
*/
#ifndef KEYCONSTANTS_H
#define KEYCONSTANTS_H

#include <map> //map is apecific to C++ 11
#include <string>
...
public:
    ...
    std::string Name;   // Name we will understand
};

class Keys
{
public:
    static std::map<int, KeyPair> KEYS; //We will use this map in order to map VKCode to human readable form that are kolled to our text file
};
